...
WEBHOOK_URL  = os.getenv("https://discordapp.com/api/webhooks/1434508893874294849/RFxsDrbzJUKLYHL5xn-iIcNcY-iT-nbGx71olQUuWDePDuPXbJJlJurAEAnHJfwfy4kg")                 # <-- verplicht
CHECK_URL    = os.getenv("CHECK_URL", "https://bandit.camp")
POLL_SECONDS = int(os.getenv("POLL_SECONDS", "30"))
TIMEOUT_SEC  = int(os.getenv("TIMEOUT_SEC", "15"))

# Één simpel trefwoord dat op de pagina moet staan om te triggerren
